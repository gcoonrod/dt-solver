...
Structural contract for the application shell — tiered component/feature/page boundary, vertical-split and global-shortcut behavior the page provides, and the testing coverage that must accompany each tier.
