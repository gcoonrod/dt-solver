...
The clock and data trace renderers consumed by the preview SHALL be
imported as named exports from
`@/components/canvas/WaveformTimeline` — no duplication of SVG path
generation.
